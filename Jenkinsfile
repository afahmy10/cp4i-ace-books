...
// Image variables
    def buildBarImage = "image-registry.openshift-image-registry.svc:5000/test-project/ace-image-builder-stream"
    def ocImage = "image-registry.openshift-image-registry.svc:5000/test-project/oc-builder-stream"
